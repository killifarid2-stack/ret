  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        display: ['Orbitron', 'Cairo', 'monospace'],
        arabic: ['Cairo', 'Inter', 'system-ui', 'sans-serif'],
        // Used only by the ported Player Call / Matchup broadcast cinematics
        // (info rows, HUD labels) — mirrors the reference design 1:1.
        hud: ['Rajdhani', 'Cairo', 'sans-serif'],
      },
      colors: {
